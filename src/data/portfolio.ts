...
export interface ServiceCategoryMeta {
  ...
  short: string;
  /**
   * Vivid hue for borders, glows and fills. On the #09090b ground every one of
   * these clears 5:1 as text too, but `text` below has more headroom on glass
   * surfaces, so coloured TEXT should use that instead.
   */
  glow: string;
  /** AA-safe text variant (the -400 step). */
  text: string;
  /** rgb triplet for `rgb(x y z / a)` glow alphas. */
  rgb: string;
}

export const serviceCategories: ServiceCategoryMeta[] = [
  { id: "seo",       label: "SEO & Organic Growth",     short: "SEO",        glow: "#10b981", text: "#34d399", rgb: "16 185 129" },
  { id: "web-dev",   label: "Web Development",          short: "Web Dev",    glow: "#06b6d4", text: "#22d3ee", rgb: "6 182 212" },
  { id: "app-dev",   label: "App & AI Development",     short: "App Dev",    glow: "#a855f7", text: "#c084fc", rgb: "168 85 247" },
  { id: "marketing", label: "Performance Marketing",    short: "Marketing",  glow: "#f97316", text: "#fb923c", rgb: "249 115 22" },
];
...
export interface ProjectPhase {
  label: string;
  /** Relative share of the engagement, any positive scale. */
  weight: number;
}
...
export interface ClientProject {
  ...
  /** Engagement composition, rendered as a segmented bar. */
  phases: ProjectPhase[];
...
export const clientProjects: ClientProject[] = [
  {
    ...
    phases: [
      ...
      { label: "Architecture", weight: 2 },
      { label: "Build", weight: 4 },
      { label: "Content", weight: 3 },
    ],
...

  {
    ...
    phases: [
      { label: "Tracking", weight: 2 },
      { label: "Restructure", weight: 3 },
      { label: "Landing pages", weight: 2 },
      { label: "Optimise", weight: 4 },
    ],
...

  {
    ...
    phases: [
      { label: "Audit", weight: 2 },
      { label: "Consolidate", weight: 3 },
      { label: "Clusters", weight: 4 },
      { label: "Local", weight: 2 },
    ],
...

  {
    ...
    phases: [
      { label: "Research", weight: 2 },
      { label: "Funnel", weight: 3 },
      { label: "Content", weight: 3 },
      { label: "Paid media", weight: 3 },
    ],
...

  {
    ...
    phases: [
      { label: "Discovery", weight: 2 },
      { label: "Retrieval", weight: 3 },
      { label: "CRM", weight: 3 },
...

  {
    ...
    phases: [
      { label: "Architecture", weight: 2 },
      { label: "Build", weight: 4 },
      { label: "Load test", weight: 2 },
      { label: "Launch", weight: 1 },
    ],
